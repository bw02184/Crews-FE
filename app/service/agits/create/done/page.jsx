            ...
            <section>
              ...
              <Box as='div' content='text' className={`${styles.texts} gray_t1`}>
                ...
                <Text as="p" weight="light">
                  모임 통장을 지금 개설하시겠습니까? <i className="dpb"></i>  ※ 이미 사용중인 계좌 연결은 아지트 홈에서 가능합니다.
                </Text>
              </Box>
              <Box as='div' content='button' className={styles.buttons}>
                <ButtonM leftButton={{ as: 'link', text: '나중에', href: `/service/agits` }} rightButton={{ as: 'link', text: '생성하기', href: `/service/agits` }} />
              </Box>
            </section>
          </Flex>
        </Flex>
